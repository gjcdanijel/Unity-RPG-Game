...
public class Player : MonoBehaviour
{
    ...
    [SerializeField] private float groundCheckDisance;
    ...
    public bool IsGroundDetected() => Physics2D.Raycast(groundCheck.position, Vector2.down, groundCheckDisance, whatIsGround);
